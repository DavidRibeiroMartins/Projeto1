...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "David Martins", 30, "david_bool@hotmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Jessica Martins", 27, "jessicasp@gmail.com", conta02.getId(), true);
		Cliente cliente03 = new Cliente(3, "Pedro Martins", 20, "Pedro@gmail.com", conta03.getId(), true);
