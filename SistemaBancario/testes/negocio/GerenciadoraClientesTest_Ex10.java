...
public class GerenciadoraClientesTest_Ex10 {
	...
	public void setUp() {
		...
		Cliente cliente01 = new Cliente(idCLiente01, "David", 30, "david_bool@hotmail.com", 1, true);
		Cliente cliente02 = new Cliente(idCLiente02, "Jessica Martins", 27, "jessicasp@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "David", 25, "david_bool@hotmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_02() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "David", 18, "david_bool@hotmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_03() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "David", 65, "david_bool@hotmai.com", 1, true);
	...
	public void testClienteIdadeAceitavel_04() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "David", 17, "david_bool@hotmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_05() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "David", 66, "david_bool@hotmail.com", 1, true);
		/* ========== Execução ========== */
		try {
			gerClientes.validaIdade(cliente.getIdade());
			fail();
